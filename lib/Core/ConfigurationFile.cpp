...
template <> struct ScalarEnumerationTraits<clang::InputKind::Language> {
  static void enumeration(IO &io, clang::InputKind::Language &lang) {
    io.enumCase(lang, "c", clang::InputKind::C);
    io.enumCase(lang, "c++", clang::InputKind::CXX);
    io.enumCase(lang, "objective-c", clang::InputKind::ObjC);
    io.enumCase(lang, "objective-c++", clang::InputKind::ObjCXX);
  }
};
